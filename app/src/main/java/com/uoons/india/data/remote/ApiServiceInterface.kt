...
interface ApiServiceInterface {
    ...
    @POST(SEND_OTP)
    suspend fun login(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : LogingResponseModel

    @GET(FORCE_UPDATE)
    suspend fun checkAPKUpdatedVersion(@Header("Channel-Code") ChannelCode: String,@Query("versionCode") versionCode: String) : ForceUpdatedModel

    @POST(OTP_VERIFICATION)
    suspend fun otp_Verification(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : OTPResponseModel

    @POST(SAVE_USER_DETAILS)
    suspend fun saveUserDetails(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : SaveUserDetailsResponse

    @POST(SAVE_BANK_DETAILS)
    suspend fun saveBankDetails(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : SaveBankDetailsModel
    ...
    suspend fun deleteBankDetails(@Header("Channel-Code") ChannelCode: String, @Body body: HashMap<String, Any>) : FetchBankDetailsModel

    @POST(SELECTED_PRIMARY_ACCOUNT)
    suspend fun selectPrimaryAccount(@Header("Channel-Code") ChannelCode: String, @Body body: HashMap<String, Any>) : FetchBankDetailsModel
    ...
    suspend fun getMoreDeshBoardProducts(@Header("Channel-Code") ChannelCode: String,@Query("page") page: Int) : HomePageMoreItemsDataModel

    @POST(HOME_PAGE_ITEMS_DATA)
    suspend fun getHomepageItemsData(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : ProductModel

    @POST(ADD_RECENTLY_VIEW_PRODUCT)
    suspend fun addRecentlyView(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : AddRecentlyViewModel

    @POST(HOME_PAGE_ITEMS_DATA)
    suspend fun getFilterItemsData(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : ProductModel

    @GET(GET_ALL_CATEGORIES)
    suspend fun getAllCategories(@Header("Channel-Code") ChannelCode: String) : AllCategoryModel

    @GET(SEARCH_ALL_PRODUCTS)
    suspend fun getAllSubCategories(@Header("Channel-Code") ChannelCode: String,@Query("sortById") sortById: Int,
                                    @Query("catId") catId: Int,@Query("filters") filters: String) : SubCategoriesModel

    @GET(PRODUCT_DETAIL)
    suspend fun getSingleProductDetail(@Header("Channel-Code") ChannelCode: String,@Query("pid") pid: Int) : ProductDetailsModel

    @GET(GET_ALL_QUESTION_ANSWERS)
    suspend fun getAllQuestionsAnswers(@Header("Channel-Code") ChannelCode: String,@Query("pid") pid: Int) : QuestionAnswerModel

    @POST(SEARCH_QUESTIONS)
    suspend fun searchQuestionAnswers(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : QuestionAnswerModel

    @POST(LIKE_UNLIKE_QUESTION)
    suspend fun postlikeUnlikeQuestion(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : QuestionLikeUnlikeModel

    @POST(LIKE_UNLIKE_REVIEW)
    suspend fun postlikeUnlikeReview(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : QuestionLikeUnlikeModel
    ...
    suspend fun postSuggestion(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : PostSuggestionResponse

    @POST(POST_YOUR_QUESTION)
    suspend fun postYourQuestion(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : PostYourQuestionModel

    @POST(CANCEL_ORDER)
    suspend fun orderCancel(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : OrderCancelModel
  @POST(ORDERCANCEL_REASON)
    suspend fun orderCancel_reason(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : OrderCancelModel

    @POST(ADD_ITEM_TO_CART)
    suspend fun addItemToCart(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : AddItemToCartDataResponse

    @POST(ADD_ITEM_TO_CART)
    suspend fun addQuantityToCart(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : AddQuantityModelResponse

    @GET(GET_MY_CART_ITEMS)
    suspend fun getMyCartItems(@Header("Channel-Code") ChannelCode: String) : GetMyCartDataModel

    @GET(SEARCH_ALL_PRODUCTS)
    suspend fun getSearchItems(@Header("Channel-Code") ChannelCode: String,@Query("searchKey") searchKey: String) : SubCategoriesModel

    @POST(ADD_WISH_LIST)
    suspend fun addToWishList(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : AddWishListResponseModel
    ...
    @GET(SEARCH_ALL_PRODUCTS)
    suspend fun getSortingData(@Header("Channel-Code") ChannelCode: String,@Query("sortById") sortById: Int,@Query("filters") filters: String) : SubCategoriesModel

    @POST(REMOVE_CART_ITEM)
    suspend fun removeCartItem(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : RemoveCartItemResponse

    @POST(REMOVE_WISH_LIST)
    suspend fun removeWishLitItem(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : RemoveCartItemResponse

    @POST(CONTACT_US)
    suspend fun contactUs(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>): ContactUsModel
    ...
    suspend fun insertNewDeliverAddress(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : DeliverAllAddressModel


    @POST(UPDATE_USER_DELIVER_ADDRESS)
    suspend fun updateNewDeliverAddress(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : DeliverAllAddressModel



    @POST(DELETE_DELIVER_ADDRESS)
    suspend fun deleteDeliverAddress(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : DeliverAllAddressModel

    @GET(PRODUCT_LOCATION_AVAILABILITY)
    suspend fun checkProductLocationAvailable(@Header("Channel-Code")ChannelCode:String,@Query("pincode")pinCode:Int,@Query("pid")pId:Int) : ProductAvailabilityResponseModel

    @POST(CHECK_COUPEN)
    suspend fun checkCoupenCode(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : CoupenCodeModel

    @POST(CHECKOUT)
    suspend fun checkOutProduct(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : CheckOutModel

    @POST(UPDATE_CHECKOUT)
    suspend fun checkOutProductUpdate(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : OnlinePaymentStatusModel

    @POST(RAZORPAY_CHECKOUT)
    suspend fun checkOutRazorpayUpdate(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>) : OnlinePaymentStatusModel
    ...
    suspend fun getOrderBundlesList(@Header("Channel-Code") ChannelCode: String,@Query("bundle_id") bundleId: String) : OrderBundleListModel

    @GET(FETCH_ORDER)
    suspend fun getOrderList(@Header("Channel-Code") ChannelCode: String,@Query("order_id") orderId: String) : OrderDetailModel

    @POST(ADD_RATING_REVIEW)
    suspend fun addRatingReview(@Header("Channel-Code") ChannelCode: String,@Body body: HashMap<String, Any>): RatingAndReviewModel
