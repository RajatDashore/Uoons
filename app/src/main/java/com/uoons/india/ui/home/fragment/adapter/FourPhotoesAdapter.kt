...
class FourPhotoesAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (getItemViewType(position) == LottieView) {
            ...
            lottieHolder.itemView.setOnClickListener {
                Toast.makeText(context, "Lottie Clicked $position", Toast.LENGTH_SHORT).show()
            }
        } else {
            ...
            simpleHolder.itemView.setOnClickListener {
                Toast.makeText(context, "Normal Clicked $position", Toast.LENGTH_SHORT).show()
            }
        }
    }
